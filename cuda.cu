...
int main() {
	...
	std::cout << "  Total Constant memory :      " << prop.totalConstMem / 1024 << std::endl;
	std::cout << "  Shared Memory per SM :       " << prop.sharedMemPerMultiprocessor /1024 << std::endl;
	...
	std::cout << "  GPU Clock Rate:             " << prop.clockRate * 1e-6 << std::endl;
